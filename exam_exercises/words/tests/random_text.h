...
static const char * T [] = {
    "Quis laoreet dictum purus auctor dignissim libero etiam duis tincidunt",
    ...
    "augue. Ultricies pulvinar litora cursus etiam dignissim. Nunc",
    "consectetur mi ultrices purus nullam neque dictum curabitur sodales",
    "pharetra ante.",
    "",
    "Consectetur id varius semper egestas habitant. Arcu posuere cursus",
    "aptent conubia quis volutpat finibus accumsan diam per malesuada quam",
    "proin elementum. Praesent libero enim gravida dignissim tristique",
    "metus gravida urna et at sagittis arcu. Malesuada donec vulputate",
    "laoreet nunc potenti molestie fringilla placerat maecenas non",
    "tincidunt praesent himenaeos. Aliquet fringilla ultrices maximus",
    "ultrices elit nisl orci fusce integer convallis.",
    "",
    "Integer erat vulputate in cras ipsum. Purus sed finibus auctor",
    ...
    "lectus bibendum conubia curae habitasse tempor purus habitant",
    "dictumst.",
    "",
    "Senectus sagittis per aliquet nam potenti nisl nisl in eleifend",
    "ultricies volutpat convallis ligula vulputate. Felis maecenas ultrices",
    "nulla lobortis ac. Volutpat consequat convallis suspendisse augue",
    "massa netus orci maximus sagittis.",
    "",
    "Vehicula quisque pharetra cras non ultricies etiam nisi vivamus etiam",
    "augue dignissim convallis dictumst vehicula. Ullamcorper rhoncus",
    "praesent vestibulum dui nisi scelerisque quisque commodo ligula proin",
    ...
    "et. Torquent lorem sit dapibus purus aptent leo felis a molestie",
    "sapien ante adipiscing primis.",
    "",
    "Curae ullamcorper mattis vitae ullamcorper quisque nisl maximus",
    ...
    "condimentum enim justo pulvinar elit laoreet nulla lobortis. Dictum",
    ...
    "in. Volutpat diam commodo sociosqu euismod egestas dolor a",
    "cubilia. Sed varius mattis convallis laoreet praesent ac porttitor",
    "morbi nullam id malesuada. Aptent sed volutpat elit congue leo",
    "ultrices.",
    "",
    ...
    "phasellus. Varius dapibus nunc faucibus adipiscing maximus. Dapibus",
    "lorem morbi lacinia mi egestas cubilia aliquet suspendisse.",
    "",
    "Platea id sapien vehicula dui venenatis ullamcorper netus aliquet cras",
    ...
    "suscipit nec egestas tempus eget nisi phasellus odio curae eget semper",
    "arcu netus.",
};

static const unsigned int T_length = sizeof(T)/sizeof(*T);
